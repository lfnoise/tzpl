...
// Scalar sinpi/cospi/tanpi/exp10 for generated plugin code live in
// tzpl_sinpi.hpp (included above) so the interpreter, the constant folder,
// and generated code share one exact implementation.
