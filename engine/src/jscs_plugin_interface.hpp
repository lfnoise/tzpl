//
//  jscs_plugin_interface.hpp
//  audio engine
//
//  Created by James McCartney on 2/2/21.
//

#ifndef jscs_plugin_interface_h
#define jscs_plugin_interface_h
...
//};
//
//struct jscs_SignalType {
//    ElemType elem; 
//    Rate rate; 
//    int chans; // number of channels.
//};
//
//struct jscs_ParamPair {
//	int index;
//	f32 value;
//};
//
...
//
//struct SynthFuns {
//    jscs_SynthData* (*alloc)();
//    jscs_SErr (*free)(jscs_SynthData* synth);
//    jscs_SErr (*init)(jscs_SynthData* synth);
//    jscs_SErr (*uninit)(jscs_SynthData* synth); // optional
//    jscs_SErr (*reset)(jscs_SynthData* synth); // optional
//    jscs_SErr (*event)(jscs_SynthData* synth, u64 id, jscs_Slice dst, jscs_Slice data);
//    //jscs_SErr (*push)(jscs_SynthData* synth, int inputIndex, int numChannels, void* data); // optional
//    void (*processEvents)(jscs_SynthData* synth);
//    void (*processAudio)(jscs_SynthData* synth);
//    
//    // note allocation. all optional.
//    jscs_SErr (*noteOn)(jscs_SynthData* synth, i64 now, int noteID, int n, f32* params);
//    jscs_SErr (*noteOff)(jscs_SynthData* synth, i64 now, int noteID);
//    jscs_SErr (*allNotesOff)(jscs_SynthData* synth, i64 now);
//    jscs_SErr (*noteSetParams)(jscs_SynthData* synth, int noteID, int n, jscs_ParamPair* params);
//    jscs_SErr (*noteSetParamRange)(jscs_SynthData* synth, int noteID, int first, int length, f32* values);
//};
//
//struct PortDef {
//    const char* name;
...
//
//void* getInput(jscs_SynthData* synth, int inputIndex);
//
