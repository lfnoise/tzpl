...
- `lang/docs/Writing_SynthDefs.html` -- SynthDef authoring guide (rates, element types, channel broadcasting, delays, buffers, voicers) + `synthdef`/`common_ugens`/`filters` reference
