...
Each sub-project has its own AGENTS.md with detailed file layouts and conventions:

- `engine/AGENTS.md` -- Engine architecture, thread safety rules, plugin ABI
- `engine/Architecture.md` -- Detailed engine design
- `synthdef-compiler/AGENTS.md` -- Compiler structure, code conventions
